...
public interface MembershipCardRepository extends JpaRepository<MembershipCard, Long> {
    ...
    @Query(value = "select new edu.nikitaMaistrenko.view.MembershipCardResponse(mc.member.lastName, mc.member.firstName, mc.membershipGYM.typeOfMembershipGYM, mc.markedWorkouts, " +
            "mc.expiredDate, mc.purchaseDate) " +
